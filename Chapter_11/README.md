...
이 챕터는 **"혼자 공부하는 파이썬"** 책의 내용을 기반으로, 공공데이터포털의 API를 활용하여 **2024년 1월부터 2025년 7월까지** 서울특별시의 아파트 매매 실거래가 데이터를 수집하고, 아래와 같은 다양한 분석을 수행하여 지도 위에 단계 구분도(Choropleth map)로 시각화하는 프로젝트입니다.
